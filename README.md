...
<table>
  <tr>
    <td width="49%">
      <a href="https://raw.githubusercontent.com/hibbitts-design/grav-plugin-helios-course-hub/refs/heads/main/screenshots/screenshot-1.png">
      <picture>
        <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/hibbitts-design/grav-plugin-helios-course-hub/refs/heads/main/screenshots/screenshot-1-dark.png">
        <img alt="Courses homepage showing two course cards with icons and descriptions" src="https://raw.githubusercontent.com/hibbitts-design/grav-plugin-helios-course-hub/refs/heads/main/screenshots/screenshot-1.png" width="100%">
      </picture>
      </a>
    </td>
    <td width="49%">
      <a href="https://raw.githubusercontent.com/hibbitts-design/grav-plugin-helios-course-hub/refs/heads/main/screenshots/screenshot-3.png">
      <picture>
  ...
  <tr>
    <td width="49%">
      <a href="https://raw.githubusercontent.com/hibbitts-design/grav-plugin-helios-course-hub/refs/heads/main/screenshots/screenshot-admin-1.png">
    ...
    <td width="49%">
      <a href="https://raw.githubusercontent.com/hibbitts-design/grav-plugin-helios-course-hub/refs/heads/main/screenshots/screenshot-admin-2.png">
...
<p align="center"><a href="https://github.com/hibbitts-design/grav-plugin-helios-course-hub/tree/main/screenshots/screenshots.md">View all screenshots</a></p>

</div>

This plugin works with the [Grav Premium Helios theme](https://getgrav.org/premium/helios) on any Grav site, providing a companion site for one or more courses with custom CSS, JavaScript, shortcodes, and enhanced Admin Panel styling. The easiest starting point is the pre-configured [Grav Helios Course Hub Skeleton](https://github.com/hibbitts-design/grav-skeleton-helios-course-hub), which includes this plugin, demo content, and all required configuration.
...
The skeleton comes pre-configured with demo content in `user/pages/cpt-363-1/` and is ready to use after licensing the Helios theme.
...
The `_demo` folder in this plugin contains a default Helios Course Hub site that can be used as a starting point:

- `00.courses/` – Courses homepage (`course-list.md` sets list page settings and default course card values)
- `cpt-363-1/` – First course (course-card.md sets icon, image, instructor, badge; 10.home, 20.essentials, 30.modules, 40.schedule, 50.topics, 60.resources, 70.guide, 80.syllabus)
...
> [!NOTE]
> This section is only needed when installing the plugin manually. The [Grav Helios Course Hub Skeleton](https://github.com/hibbitts-design/grav-skeleton-helios-course-hub) includes all of the following configuration automatically.

Add the following to `user/config/themes/helios.yaml` to configure course versioning and search:
