...
class HeliosCourseHubPlugin extends Plugin
{
    ...
    public function onTwigSiteVariables()
    {
        ...
        $rawCustomUrl = trim($this->config->get('plugins.helios-course-hub.github_header_custom_url', ''));
        $githubHeaderCustomUrl = preg_match('#^https?://#i', $rawCustomUrl) ? $rawCustomUrl : '';
        ...
        $twig->twig_vars['github_header_custom_url'] = $githubHeaderCustomUrl;
